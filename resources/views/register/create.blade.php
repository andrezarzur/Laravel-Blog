            ...
            <div class="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
                ...
                <form action="/register" method="POST" class="mt-10">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ old('name') }}" id="name" name="name" class="form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 {{ isset($errors->getMessages()['name']) ? 'border-red-400' : ''}}" required placeholder="James Brown">
                        @error('name')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" value="{{ old('username') }}" id="username" name="username" class="form-input w-full px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500 {{ isset($errors->getMessages()['username']) ? 'border-red-400' : ''}}" required placeholder="JamesB">
                        @error('username')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
